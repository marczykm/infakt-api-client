...
parser.add_argument('--sale_date',    required=True,  dest='sale_date',    help='sale date')
parser.add_argument('--invoice_date', required=False, dest='invoice_date', help='invoice date')
parser.add_argument('--payment_date', required=True,  dest='payment_date', help='payment date')
